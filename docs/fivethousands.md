...
### Nirvor Communication-এর বর্তমান নেটওয়ার্ক পরিস্থিতি

আমরা প্রথমে দেখি Nirvor Communication-এর নেটওয়ার্ক কেমন:
...
সবার আগে একটা নেমিং কনভেনশন ঠিক করে ফেলি। Nirvor Communication-এর জন্য এই স্ট্যান্ডার্ড:
...
Contact Phone: +880 1712-**5678
Contact Email: jahangir@NirvorCommunication.bd
...
Contact Phone: +880 1811-**4567
Contact Email: asif@NirvorCommunication.bd
...
SW-MIR-DIST-01,TP-Link TL-SG3428,Distribution Switch,Mirpur POP,Rack-MIR-A,20,Active,TPL1234DIST01,Nirvor-SW-001,production,"Primary distribution switch"
SW-MIR-DIST-02,TP-Link TL-SG3428,Distribution Switch,Mirpur POP,Rack-MIR-A,19,Active,TPL1234DIST02,Nirvor-SW-002,production,"Secondary distribution switch"
```
...
```csv
name,device_type,role,location,rack,position,status,serial,asset_tag,tags,description
SW-MIR-ACC-01,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,15,Active,TPLACC001,Nirvor-SW-011,production,"Building-A access"
SW-MIR-ACC-02,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,14,Active,TPLACC002,Nirvor-SW-012,production,"Building-B access"
SW-MIR-ACC-03,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,13,Active,TPLACC003,Nirvor-SW-013,production,"Building-C access"
SW-MIR-ACC-04,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,12,Active,TPLACC004,Nirvor-SW-014,production,"Building-D access"
SW-MIR-ACC-05,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,11,Active,TPLACC005,Nirvor-SW-015,production,"Building-E access"
SW-MIR-ACC-06,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,10,Active,TPLACC006,Nirvor-SW-016,production,"Building-F access"
SW-MIR-ACC-07,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,9,Active,TPLACC007,Nirvor-SW-017,production,"Building-G access"
SW-MIR-ACC-08,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,8,Active,TPLACC008,Nirvor-SW-018,production,"Building-H access"
SW-MIR-ACC-09,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,7,Active,TPLACC009,Nirvor-SW-019,production,"Building-I access"
SW-MIR-ACC-10,TP-Link TL-SG1024D,Access Switch,Mirpur POP,Rack-MIR-A,6,Active,TPLACC010,Nirvor-SW-020,production,"Building-J access"
```
...
DNS Name: r-mir-core-01-uplink.NirvorCommunication.bd
...
DNS Name: sw-mir-dist-01.NirvorCommunication.bd
```
...
DNS Name: sw-mir-dist-02.NirvorCommunication.bd
```
...
10.10.10.21/24,Active,dcim.interface,SW-MIR-ACC-01:vlan10,sw-mir-acc-01.NirvorCommunication.bd,Management IP
10.10.10.22/24,Active,dcim.interface,SW-MIR-ACC-02:vlan10,sw-mir-acc-02.NirvorCommunication.bd,Management IP
10.10.10.23/24,Active,dcim.interface,SW-MIR-ACC-03:vlan10,sw-mir-acc-03.NirvorCommunication.bd,Management IP
10.10.10.24/24,Active,dcim.interface,SW-MIR-ACC-04:vlan10,sw-mir-acc-04.NirvorCommunication.bd,Management IP
10.10.10.25/24,Active,dcim.interface,SW-MIR-ACC-05:vlan10,sw-mir-acc-05.NirvorCommunication.bd,Management IP
10.10.10.26/24,Active,dcim.interface,SW-MIR-ACC-06:vlan10,sw-mir-acc-06.NirvorCommunication.bd,Management IP
10.10.10.27/24,Active,dcim.interface,SW-MIR-ACC-07:vlan10,sw-mir-acc-07.NirvorCommunication.bd,Management IP
10.10.10.28/24,Active,dcim.interface,SW-MIR-ACC-08:vlan10,sw-mir-acc-08.NirvorCommunication.bd,Management IP
10.10.10.29/24,Active,dcim.interface,SW-MIR-ACC-09:vlan10,sw-mir-acc-09.NirvorCommunication.bd,Management IP
10.10.10.30/24,Active,dcim.interface,SW-MIR-ACC-10:vlan10,sw-mir-acc-10.NirvorCommunication.bd,Management IP
```
...
Nirvor Communication-এর জন্য কিছু দরকারি Custom Fields:
...
Nirvor Communication-এর তিনজন টেকনিশিয়ান আছে:
...
5. Nautobot Access
   - URL: https://nautobot.Nirvor Communication.bd
